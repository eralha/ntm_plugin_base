    ...
    var vals = angular.module('formVals', []);


    vals.directive('formValidator', ['$timeout',
        function($timeout) {
      return {
        restrict: 'A',
    ...
    vals.directive('fieldValidator', ['$timeout',
        function($timeout) {
      return {
        restrict: 'A',
        scope: {
        ...
        link: function(scope, element, attrs, ctrl) {
            ...
            function runValidators(setClass, viewValue){
              ...
              if(messages.length > 0){
                ...
                //deleting messages for this input
                //we can check this var in our controller to see if there are erros.
                delete scope.messages[ctrl.$name];
              }
            ...
            ctrl.$parsers.unshift(function (viewValue) {
              ...
              return (scope.messages[ctrl.$name])? undefined : viewValue;
            });
